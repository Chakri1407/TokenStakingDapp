...
const Wallet = ({ children }) => {
  ...
  const handleWallet = async () => {
    try {
      ...
      //console.log("Provider:",provider,"SelectedAccount:",selectedAccount,"StakingContract:",stakingContract,"StakeTokenContractAddress",stakeTokenContract,"ChainID:",chainId)
      setState({
        provider,
        selectedAccount,
        stakingContract,
